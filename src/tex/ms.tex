...
\end{align}\end{linenomath}
%
Substituting $1/r_{NS} = y$, and expanding around $y=0$, if Sabina hasn't made any mistakes, the integral gives
%
\begin{linenomath}\begin{align}
    \label{eq:tdelay-solved}
    \Delta t = -\frac{1}{8}x \frac{1}{r_{NS}^2}(4+4(4+x)\frac{1}{r_{NS}}),
\end{align}\end{linenomath}
%
where $-1<x<1$.
\bibliography{bib}
